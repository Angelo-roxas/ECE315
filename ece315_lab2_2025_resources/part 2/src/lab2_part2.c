...
static QueueHandle_t xUartInputQueue;
static QueueHandle_t xLoginQueue;
//TickType_t xPollPeriod = 100;
/*****************************************************************************/
...
/*****************************************************************************/
    ...
    xLoginQueue = xQueueCreate(QUEUE_LENGTH, sizeof(LoginData));
...
/*************************** Enter your code here ****************************/
        ...
        if (xQueueReceive(xGreenLedQueue, &message, portMAX_DELAY) == pdTRUE) {
...
void vUartTask(void *pvParameters)
{
	...
	while (1) {
		...
		if (XUartPs_IsReceiveData(UART_BASEADDR)) {
            ...
            xQueueSend(xUartInputQueue, &cReceivedByte, portMAX_DELAY);
        }
        vTaskDelay(xPollPeriod / portTICK_PERIOD_MS);
		/*****************************************************************************/
	}
}
    ...
    while (1) {
        ...
        if (strcmp(buffer, "logout") == 0) {
            ...
            if (strcmp(cmdStr, "E7") == 0) {
                ...
                msg.type = 'a';
            } else if (strcmp(cmdStr, "F3") == 0) {
                msg.type = 's';
            } else if (strcmp(cmdStr, "D1") == 0) {
                msg.type = 'r';
            } else {
